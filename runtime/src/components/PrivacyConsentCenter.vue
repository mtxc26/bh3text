...
.link-btn { display: flex; align-items: center; justify-content: space-between; padding: 14px 16px;
  border: 1px solid #ddd; border-radius: 8px; background: #fafafa; color: #333; font-size: 14px;
  font-weight: 500; cursor: pointer; transition: background 0.15s; text-align: left; }
.link-btn:hover { background: #f0f0f0; }
.arrow { color: #999; font-size: 16px; }
.close-row { display: flex; justify-content: flex-end; margin-top: 20px; }
.btn-close { padding: 8px 20px; border: none; border-radius: 8px; background: #f0f0f0; color: #333;
